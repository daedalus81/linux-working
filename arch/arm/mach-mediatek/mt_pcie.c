			    ...
			    unsigned long reg, unsigned long *val)
{
	...
	address = EXTREGNUM(((reg & 0xf00)>>8)) | BUSNUM(bus) |
		  ...
		  REGNUM(reg & 0xfc) ;
	//printk("%s: bus=%x, dev=%d, func=%x, reg=0x%x, address=0x%x\n",
			      ...
			      int size, u32 *val)
{
	...
	//printk("%s: bus=%d, dev=%d, func=%d, offset=0x%x, data=0x%x\n",
	//__func__,  bus->number, slot, (u32)func, where, data);
			       ...
			       int size, u32 val)
{
	...
	//printk("%s: bus=%d, dev=%d, func=%d, offset=0x%x, rdata=0x%x,
	//wdata=0x%x\n", __func__,  bus->number, slot, (u32)func, where, data,
	//val);
...
{
	printk("%s: GPIO_MODE5 SHAREPIN (%x) =%x\n",
			__func__, GPIOMODE5, REGDATA(GPIOMODE5));
	printk("%s: GPIO_MODE42 SHAREPIN (%x) =%x\n",
			__func__, GPIOMODE42, REGDATA(GPIOMODE42));
	printk("%s: GPIO_MODE51 SHAREPIN (%x) =%x\n",
			__func__, GPIOMODE51, REGDATA(GPIOMODE51));
	printk("%s: GPIO_MODE52 SHAREPIN (%x) =%x\n",
...
{
#if defined (CONFIG_PCIE_PORT0)
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC00, REGDATA(PHY_P0_CTL+0xC00));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0x9E0, REGDATA(PHY_P0_CTL+0x9E0));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0x9E4, REGDATA(PHY_P0_CTL+0x9E4));
	REGDATA(PHY_P0_CTL+0xC00) &= ~(0x33000);
	REGDATA(PHY_P0_CTL+0xC00) |=   0x22000;
#if 1
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xB04, REGDATA(PHY_P0_CTL+0xB04));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xB00, REGDATA(PHY_P0_CTL+0xB00));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC3C, REGDATA(PHY_P0_CTL+0xC3C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC48, REGDATA(PHY_P0_CTL+0xC48));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC0C, REGDATA(PHY_P0_CTL+0xC0C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC08, REGDATA(PHY_P0_CTL+0xC08));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC10, REGDATA(PHY_P0_CTL+0xC10));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC14, REGDATA(PHY_P0_CTL+0xC14));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0x9E4, REGDATA(PHY_P0_CTL+0x9E4));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0x97C, REGDATA(PHY_P0_CTL+0x97C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xB04, REGDATA(PHY_P0_CTL+0xB04));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xB00, REGDATA(PHY_P0_CTL+0xB00));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xC14, REGDATA(PHY_P0_CTL+0xC14));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0x938, REGDATA(PHY_P0_CTL+0x938));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P0_CTL+0xB28, REGDATA(PHY_P0_CTL+0xB28));
#endif
#if defined (CONFIG_PCIE_PORT1)
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xC00, REGDATA(PHY_P1_CTL+0xC00));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0x9E0, REGDATA(PHY_P1_CTL+0x9E0));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0x9E4, REGDATA(PHY_P1_CTL+0x9E4));
	REGDATA(PHY_P1_CTL+0xC00) &= ~(0x33000);
	REGDATA(PHY_P1_CTL+0xC00) |=   0x22000;
#if 1
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xB04, REGDATA(PHY_P1_CTL+0xB04));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xB00, REGDATA(PHY_P1_CTL+0xB00));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xC3C, REGDATA(PHY_P1_CTL+0xC3C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xC48, REGDATA(PHY_P1_CTL+0xC48));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xC0C, REGDATA(PHY_P1_CTL+0xC0C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xC08, REGDATA(PHY_P1_CTL+0xC08));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xC10, REGDATA(PHY_P1_CTL+0xC10));
	printk("%s: PCIe PHY (%x) =%x\n", __func__,
			PHY_P1_CTL+0xC14, REGDATA(PHY_P1_CTL+0xC14));
...
#endif
	mdelay(10);
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xC00,
			REGDATA(PHY_P1_CTL+0xC00));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0x9E0,
			REGDATA(PHY_P1_CTL+0x9E0));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0x9E4,
			REGDATA(PHY_P1_CTL+0x9E4));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0x97C,
			REGDATA(PHY_P1_CTL+0x97C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xB04,
			REGDATA(PHY_P1_CTL+0xB04));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xB00,
			REGDATA(PHY_P1_CTL+0xB00));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xC3C,
			REGDATA(PHY_P1_CTL+0xC3C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xC48,
			REGDATA(PHY_P1_CTL+0xC48));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xC0C,
			REGDATA(PHY_P1_CTL+0xC0C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xC08,
			REGDATA(PHY_P1_CTL+0xC08));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xC10,
			REGDATA(PHY_P1_CTL+0xC10));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xC14,
			REGDATA(PHY_P1_CTL+0xC14));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0x938,
			REGDATA(PHY_P1_CTL+0x938));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P1_CTL+0xB28,
			REGDATA(PHY_P1_CTL+0xB28));
#endif
#if defined (CONFIG_PCIE_PORT2)
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC00,
			REGDATA(PHY_P2_CTL+0xC00));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0x9E0,
			REGDATA(PHY_P2_CTL+0x9E0));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0x9E4,
			REGDATA(PHY_P2_CTL+0x9E4));
	REGDATA(PHY_P2_CTL+0xC00) &= ~(0x33000);
	REGDATA(PHY_P2_CTL+0xC00) |=   0x22000;
#if 1
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xB04,
			REGDATA(PHY_P2_CTL+0xB04));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xB00,
			REGDATA(PHY_P2_CTL+0xB00));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC3C,
			REGDATA(PHY_P2_CTL+0xC3C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC48,
			REGDATA(PHY_P2_CTL+0xC48));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC0C,
			REGDATA(PHY_P2_CTL+0xC0C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC08,
			REGDATA(PHY_P2_CTL+0xC08));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC10,
			REGDATA(PHY_P2_CTL+0xC10));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC14,
			REGDATA(PHY_P2_CTL+0xC14));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0x9E4,
			REGDATA(PHY_P2_CTL+0x9E4));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0x97C,
			REGDATA(PHY_P2_CTL+0x97C));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xB04,
			REGDATA(PHY_P2_CTL+0xB04));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xB00,
			REGDATA(PHY_P2_CTL+0xB00));
	...
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xC14,
			REGDATA(PHY_P2_CTL+0xC14));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0x938,
			REGDATA(PHY_P2_CTL+0x938));
	printk("%s: PCIe PHY (%x) =%x\n", __func__, PHY_P2_CTL+0xB28,
			REGDATA(PHY_P2_CTL+0xB28));
#endif
}
...
void __init mtk_pcie_preinit(void)
{
	...
	printk("RC0 FC credit = %x", (unsigned int)val);
	val &= ~(0x9fff)<<16;
	val |= 0x806c<<16;
	...
	printk("RC1 FC credit = %x", (unsigned int)val);
	val &= ~(0x9fff)<<16;
	val |= 0x806c<<16;
	...
	printk("RC2 FC credit = %x", (unsigned int)val);
	val &= ~(0x9fff)<<16;
	val |= 0x806c<<16;
	...
	do {
		...
		{
			printk("PCIE0 Link down\n");
			val |= RSTCTL_PCIE0_RST;
			pcie_link_status &= ~(1<<0);
			mdelay(1000);
		} else {
			printk("PCIE0 Link up\n");
			pcie_link_status |= 1<<0;
		}
	...
	do {
		...
		{
			printk("PCIE1 Link down\n");
			val |= RSTCTL_PCIE1_RST;
			pcie_link_status &= ~(1<<1);
			mdelay(1000);
		} else {
			printk("PCIE1 Link up\n");
			pcie_link_status |= 1<<1;
		}
	...
	do {
		...
		{
			printk("PCIE2 Link down\n");
			val |= RSTCTL_PCIE2_RST;
			pcie_link_status &= ~(1<<2);
			mdelay(1000);
		} else {
			printk("PCIE2 Link up\n");
			pcie_link_status |= 1<<2;
		}
	...
	REGDATA(PCICFG) = val;
	printk("%s: PCICFG[27:16] (%x) =%x\n", __func__, PCICFG,
	       REGDATA(PCICFG));
	printk("PCIE Device number setting of Virtual PCI-PCI Setup OK\n");
#endif
	...
	default:
		...
		read_config(0, 0, 0, 0x70c, &val);
		printk("Bus0-Slot0 N_FTS = %x\n", (unsigned int)val);
	}
	printk("########## PCIe Initialization Done ##########\n");
}
