...
#endif //#if !defined (CONFIG_TRUSTONIC_TEE)
...
typedef int (*spm_mtcmos_ctrl_func)(int state, int check);
...
int __cpuinit mt_smp_boot_secondary(unsigned int cpu, struct task_struct *idle)
{
	...
	else
	{
		...
		printk(KERN_EMERG "CPU2, debug event: 0x%08x, debug monitor:"
				"0x%08x\n", *(volatile u32 *)(0xF020021c),
				*(volatile u32 *)(0xF0200014));
		mt65xx_reg_sync_writel( 0x3, 0xF020021c);
		printk(KERN_EMERG "CPU3, debug event: 0x%08x, debug monitor:"
				"0x%08x\n", *(volatile u32 *)(0xF020021c),
				*(volatile u32 *)(0xF0200014));
		on_each_cpu((smp_call_func_t)dump_stack, NULL, 0);
#else
		mt65xx_reg_sync_writel(cpu + 8, 0xf0200080);
		printk(KERN_EMERG "CPU%u, debug event: 0x%08x, debug monitor:"
				"0x%08x\n", cpu, *(volatile u32 *)(0xf0200080),
				*(volatile u32 *)(0xf0200084));
		on_each_cpu((smp_call_func_t)dump_stack, NULL, 0);
#endif
