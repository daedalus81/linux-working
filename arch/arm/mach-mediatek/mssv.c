...
static ssize_t track_vsram_store(struct device_driver *driver,
...
static ssize_t ptp_od_store(struct device_driver *driver,
		const char *buf, size_t count)
{
	return count;
}
...
static ssize_t chip_id_store(struct device_driver *driver,
		const char *buf, size_t count)
{
	return count;
}
